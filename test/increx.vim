...
let s:test_cases = [
      ...
      \ { 'line': '  m9  ', 'col': 3, 'count': 1, 'want_line': '  m10  ', 'want_col': 5 },
      ...
      \ { 'line': '0xFFFF', 'col': 4, 'count': -16, 'want_line': '0xFFEF', 'want_col': 6 },
      ...
      \ { 'line': '  a0-11  ', 'col': 7, 'count': -1, 'want_line': '  a0-12  ', 'want_col': 7 },
      ...
      \ { 'line': 'yes', 'col': 1, 'count': 1, 'want_line': 'no', 'want_col': 2 },
      \ { 'line': 'no', 'col': 2, 'count': 1, 'want_line': 'yes', 'want_col': 3 },
      ...
      \ { 'line': '&&&', 'col': 1, 'count': 1, 'want_line': '&&&', 'want_col': 1 },
      \ { 'line': '&&&&', 'col': 1, 'count': 1, 'want_line': '&&&&', 'want_col': 1 },
